...
const ProjectCard = ({
  ...
  <div className="bg-white rounded-lg shadow-lg overflow-hidden">
    ...
    <div className="p-6">
      ...
      <p className="text-gray-700">{grants}</p>
    </div>
  </div>
);
      ...
      <div className="flex flex-col items-center justify-center min-h-screen py-1">
        ...
        <main className="flex flex-col items-center justify-center flex-1 px-10 text-center">
          <div className="container mx-auto">
            ...
            <p>
              Started with the initial focus on construction skills, C-STEMP has
              carried out several projects and broadened its scope to include
              other economic sectors through several partnership projects.{" "}
            </p>
