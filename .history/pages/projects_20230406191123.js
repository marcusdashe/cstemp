...
const ProjectCard = ({
  ...
  return (
    <div className="flex flex-col md:flex-row bg-white rounded-lg shadow-lg mt-10 overflow-hidden outline">
      <div className="relative h-0 md:pb-[40%] md:w-2/5 lg:w-1/2 outline">
        <Image
          src={imageUrl}
          alt={title}
          width={300}
      ...
      <div className="p-4 md:p-6 md:w-3/5 lg:w-1/2 flex flex-col justify-between outline">
        <div>
          <h2 className="text-xl font-bold mb-2 p-8 outline">
