...
// }) => {
//   return (
//     <div className="flex flex-col md:flex-row bg-white rounded-lg shadow-lg mt-10">
//       <div className="relative h-0 pb-[40%] md:w-2/5 lg:w-1/2 outline-red-500">
//         <Image
//           src={imageUrl}
//           alt={title}
//           width={300}
...
//         <div>
//           <h2 className="text-xl font-bold mb-2 p-8">
//             {title} <span className="text-gray-500 font-normal">{date}</span>
//           </h2>
//           <p className="text-gray-700 pb-1 text-justify">{description}</p>
//         </div>
//       </div>
//     </div>
//   );
...
//         <main className="flex w-[80%] flex-col items-center justify-center flex-1 px-10 text-center">
