...
const HEROES = [
  ...
  },
  {
    ...
    sub: "Coordinator Special Projects",
    fb: "https://www.facebook.com/",
    twitter: "https://www.twitter.com/",
  },
];
  ...
  return (
    <>
      ...
      >
        ...
        <div className="outline w-full flex flex-col lg:flex-row lg:flex-wrap md:flex-row md:flex-wrap w-full items-center content-center justify-center lg:items-center lg:content-center lg:justify-center md:items-center md:content-center md:justify-center">
          {HEROES.map((ser, i) => {
            return (
              <div
