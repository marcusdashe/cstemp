...
const Hero = () => {
  return (
    <div className="container mx-auto ">
      ...
      <p className="flex w-90 font-medium justify-around">
          <span className=""><img src="/assets/talent.png" alt="" className="object-scale-down h-50 w-20"/>Training Talent</span> 
          <span><img src="/assets/dskills.png" alt="" />Outsourcing Skills</span> 
          <span><img src="/assets/empowerment.png" alt="" />Empowerment</span> 
          <span><img src="/assets/award.png" alt="" />Awarding Artisan</span></p>
