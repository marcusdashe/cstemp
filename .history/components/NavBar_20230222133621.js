  ...
  return (
    <div className='mx-auto '>
        <div className="container flex flex-col lg:flex-row py-2 justify-between items-center">
            <img src="/assets/logo.png" alt="logo" className="object-scale-down h-100 w-30" />
            ...
            <div className="flex items-center gap-8 ">
                <p className='text-base font-medium cursor-pointer'>Home</p>
                <p className='text-base font-medium cursor-pointer'>About</p>
                <p className='text-base font-medium cursor-pointer'>Services</p>
                <p className='text-base font-medium cursor-pointer'>Contact</p>
                <p className='text-base font-medium cursor-pointer'>Project</p>
                <p className='text-base font-medium cursor-pointer'>Useful Links</p>
                <p className='text-base font-medium cursor-pointer'>Gallery</p>
            {/* </div>
