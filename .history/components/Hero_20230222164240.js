      ...
      <div className="flex flex-col md:flex-row justify-between items-center py-10">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-lg text-gray-600">
            ...
            Our goal is to traing, empower and support people, especially the youth. <br />
            Interfacing them with developers and industry leaders to create a synergy 
            between labor demand and labor supply. Work with us today.
          </p>
