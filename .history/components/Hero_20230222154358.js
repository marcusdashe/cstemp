...
const Hero = () => {
  return (
    <div className="container mx-auto ">
      ...
      <p className="flex w-90 font-medium justify-around"><span className=""><img src="/assets/talent.png" alt="" />Training Talent</span> {"  "} <span>Outsourcing Skills</span> <span>Empowerment</span> <span>Awarding Artisan</span></p>
