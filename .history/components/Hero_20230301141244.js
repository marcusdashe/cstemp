...
export default function Hero() {
  return (
    <>
      <div className="lg:h-[100vh] px-3 py-3 lg:px-0 lg:py-0 md:px-0 md:py-0 md:h-[100vh] h-[80vh] w-auto lg:w-full md:w-full flex flex-col lg:flex-row md:flex-row justify-between items-center content-center">
        {/* right side */}
