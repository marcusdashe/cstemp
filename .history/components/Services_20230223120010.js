...
const Services = () => {
  ...
  return (
    <div className='container mx-auto items-center py-10'>
        ...
        <p className='text-3xl font-semibold text-center py-3'>We provide assessment and certification services 
        to experienced artisans, job placements, <br />labor outsourcing and artisans awards programs.<br />
