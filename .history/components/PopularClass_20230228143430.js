    ...
    <>
      <div className="lg:px-20 md:px-20 lg:py-10 md:py-20">
        ...
        <p className="text-gray-500 text-base text-center lg:text-start md:text-start py-3">
            C-STEMP is poised to satisfy the need for skilled manpower, <br />by establishing a wide area network of 
            technology enabled vocational training centers that offer training on a good number of soft and hard skills.
        </p>
