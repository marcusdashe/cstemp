...
const Hero = () => {
  return (
    <div className="container mx-auto ">
      ...
      <p className="flex w-100 border justify-between"><span className="border">Training Talent</span> {"  "} <span>Outsourcing Skills</span> <span>Empowerment</span> <span>Awarding Artisan</span></p>
