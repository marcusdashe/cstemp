...
const Hero = () => {
  return (
    <div className="container mx-auto ">
      ...
      <p className="w-100% items-center"><span className="border">Training Talent</span> {"  "} <span>Outsourcing Skills</span> <span>Empowerment</span> <span>Awarding Artisan</span></p>
