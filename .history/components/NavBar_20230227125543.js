...
const NavBar = () => {
  return (
    <div className='mx-auto mt-8 sticky top-0 z-50 bg-white shadow-sm'>
        <div className="container flex flex-col lg:flex-row py-2 justify-between items-center">
            ...
            <div className="flex items-center gap-8">
                ...
                <p className='text-base font-medium cursor-pointer hover:text-[#8D161A]'>Contact Us</p>
                <p className='text-base font-medium cursor-pointer hover:text-[#8D161A]'>Projects</p>
